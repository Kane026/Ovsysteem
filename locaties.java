...
// berekent totale afstand door de index van de eindhalte - de beginhalte te doen math.abs zorgt ervoor dat er altijd een positief getal is 
	int totaleAfstand = Math.abs(indexeindHalte - indexbeginHalte);
	// maakt variable prijs voor totale prijs aan door de totale afstand keer 4 te
	// doen waarin 4 een standaard prijs is
